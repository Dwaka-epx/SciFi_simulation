...
void v3_mac(TString fname="mydata_gamma")
{
  ...
  for (int i=0; i<300; i++) {
    ...
    TH1F *dEdz_photon = new TH1F("dEdz_photon","dEdz_photon"+fname,number_of_actuallayers,offset,number_of_actuallayers+offset);
	...
	//Filling histgrams of dEdz
	dEdz_photon->Fill(l,photon);
