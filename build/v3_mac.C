...
#define number_of_event_display 200
#define draw_true 0
#define pickup 0
...
void v3_mac(TString fname="mydata_neut_5.4.0_675MeV_H2O_numu_1e5event")
{
  ...
  TH2D *h_2D_dEdz_photon = new TH2D("h_2D_dEdz_photon","h_2D_dEdz_photon"
				  , number_of_actuallayers, offset, number_of_actuallayers+offset
				  ,pe_max, 1, pe_max + offset);
  ...
  for (int i=0; i<10000; i++) {
	...
	if( l%unit==3 ) { // VZ layer
      ...
      h_2D_dEdz_photon->Fill(l-first_hit_layer, sum_photon_lth_layer);
